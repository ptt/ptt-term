...
module.exports = {
  ...
  plugins: [
    new webpack.DefinePlugin({
      ...
      'process.env.DEFAULT_PROFILE': JSON.stringify(process.env.DEFAULT_SITE_TYPE || process.env.DEFAULT_PROFILE || 'auto'),
      'process.env.DEFAULT_SITE_TYPE': JSON.stringify(process.env.DEFAULT_SITE_TYPE || process.env.DEFAULT_PROFILE || 'auto'),
